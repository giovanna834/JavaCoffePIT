...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <div class="cadastro">
      <form  action="{{route('cadastrar_cartao')}}" method="post" class="row g-4">
        @csrf
        <div class="col-md-10">
        ...
        <div class="col-6">
          ...
          <input type="text" class="form-control" name="Data" placeholder="Ex: 02/25" required>
        </div>
        <div class="col-12">
          <button type="submit" class="botao-endereco">Cadastrar cartão</button>
        </div>
      </form>
    </div>
